...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>ReplayStore & Tecnología</i></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./Controlador?accion=home"><i class="fas fa-plus-circle"></i> Más Vendidos</a>
                    </li>                   
                    <li class="nav-item">
        ...
        <div class="container mt-4">
            <div class="d-flex">
                <h4>LISTA DE CARRITO DE COMPRA</h4>     
                <%
                ...
                <div class="col-lg-3">                  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a class="form-control text-center"><i class="fas  h5">S/.  ${totalPagar}0</i></a>
                            <label>Precio Envio:</label>
                            <a class="form-control text-center"><i class="fas  h5">S/. 0.00</i></a>
                            <label>Descuento:</label>
                            <a class="form-control text-center"><i class="fas  h5">S/. 0.00</i></a>
                            <label>Neto a Pagar:</label>
                            <a class="form-control text-center"><i class="fas  h4 primary">S/. ${totalPagar}0</i></a>
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input type="text" name="txtnom" class="form-control" placeholder="Nombre Completo">
                                        </div>
                                        <div class="form-group">
                                            <label>Dni</label>
                                            <input type="number" name="txtdni" class="form-control" placeholder="12345678">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input type="text" name="txtdire" class="form-control" placeholder="Lima - Villa el Salvador">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" name="txtemail" class="form-control" placeholder="email@example.com">
