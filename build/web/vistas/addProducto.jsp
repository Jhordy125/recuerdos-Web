...
<html>
    <head>
        ...
        <title>.: Productos - ReplayStore & Tecnología.</title>
    ...
    <body>
                            ...
                            <c:forEach var="p" items="${productos}">
                                <tr class="text-center">
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <a id="eliminarproducto" class="btn btn-danger" name="accion" value="EliminarProducto">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>                           
                        </tbody>
        ...
        <script src="js/funcionesProducto.js" type="text/javascript"></script>
