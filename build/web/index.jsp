...
<html>
    <head>
        ...
        <title>-.:ReplayStore & Tecnología - Compras:. </title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <div class="navbar buscar">
                         <form class="form-inline">  
                    <input type="search" name="txtbuscar"  class="form-control"> 
                    <input type="submit" name="accion" value="Buscar" class="btn btn-outline-danger">
                </form>
            </div>
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-body text-center d-flex">
                                    <label><i class="fas ">S/. ${p.getPrecio()}</i></label>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <div class="form-group">
                                            <label>Dni</label>
                                            <input type="text" maxlength="8" name="txtdni" class="form-control" placeholder="00000000">
                                        </div>
                                        <div class="form-group">
